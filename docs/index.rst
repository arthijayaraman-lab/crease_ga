...
d.	*Analyze the dispersity in both the nanoparticle size and shape using 1D scattering profiles* **[19]**: CREASE interpretation of 1D SAXS profiles showed how dispersity in both nanoparticle size and shape could result in featureless scattering profiles for the nanoparticles. **[19]**.

...
class scatterer_generator:
    ...
    **The following 7 parameters are to be predicted, in the precise order
    ...
    def __init__(self,
                 shape_params = [0.5,1,0.5],
                minvalu = (20, 0.1, 0.01, 0.01, 0.2, 0.1),
                maxvalu = (3000, 0.95, 0.99, 0.99, 5, 4)):
    ...
    def converttoIQ(self, qrange, param):
        ...
        r = genLP(R_core, dR_Ain, dR_B, dR_Aout, scat_density, self.sB, sAin) 
